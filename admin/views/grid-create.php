	...
	<div class="inside" style="padding:0px !important;margin:0px !important;height:100%;position:relative;background:#e1e1e1">
		...
		<div id="esg-settings-posts-settings" class="esg-settings-container">
			<div class="">
				<form id="eg-form-create-posts">					
					<div class="eg-creative-settings">
						...
						<div class="eg-cs-tbc esg-form-table-cell">
					...
					<div id="all-stream-wrap">
						...
						<div id="instagram-external-stream-wrap">
							<!--div class="eg-creative-settings">
								...
								<div class="eg-cs-tbc">
									<p>
										<label class="eg-new-label eg-tooltip-wrap" title="<?php _e('Put in your Instagram Access Token', EG_TEXTDOMAIN); ?>"><?php _e('Access Token', EG_TEXTDOMAIN); ?></label>
									</p>
									<p>
										<input style="margin-right:10px" type="text" value="<?php echo $base->getVar($grid['postparams'], 'instagram-access-key', ''); ?>" name="instagram-access-key">	
										<span class="description"><?php _e('Read <a target="_blank" href="https://demo.accesspressthemes.com/wordpress-plugins/accesspress-instagram-feeds-pro/2016/11/04/how-to-create-an-instagram-access-token-key/">here</a> how to get your Instagram access token', EG_TEXTDOMAIN); ?></span>
									</p>
								</div>
							</di>
							<div class="divider1"></divv-->
							<div class="eg-creative-settings">
								<div class="eg-cs-tbc-left">
									<h3><span><?php _e('Stream', EG_TEXTDOMAIN); ?></span></h3>
								</div>
								<div class="eg-cs-tbc">
									<p>
										...
										<!--span class="description"><?php _e(' In <a href="https://www.instagram.com/developer/sandbox/" target="_blank">Sandbox mode</a> only your own username can be used.', EG_TEXTDOMAIN); ?></span-->
									</p>
								</div>
							</div>
							<div class="divider1"></div>
						...
						<div id="behance-external-stream-wrap">
							<div class="eg-creative-settings">
								...
								<div class="eg-cs-tbc">
									<p>
										...
										<div class="tp-clearfix"></div>
										<span class="description"><?php _e('Register your app to receive an API key <a target="_blank" href="https://www.behance.net/dev">here</a>', EG_TEXTDOMAIN); ?></span>
									</p>
								</div>		
							</div>
							<div class="divider1"></div>
							<div class="eg-creative-settings">
								...
								<div class="eg-cs-tbc">
									...
									<p>
										...
										<input type="radio" name="behance-type" value="projects" class="firstinput" <?php checked($base->getVar($grid['postparams'], 'behance-type', 'projects'), 'projects'); ?>><span class="inplabel"><?php _e('Projects Overview', EG_TEXTDOMAIN); ?></span>
										<input type="radio" name="behance-type" value="project" <?php checked($base->getVar($grid['postparams'], 'behance-type', 'overview'), 'project'); ?>><span class="inplabel"><?php _e('Single Project', EG_TEXTDOMAIN); ?></span>							
									</p>
									<div id="eg-external-source-behance-project-wrap">
										<p>
											<?php $behance_project = $base->getVar($grid['postparams'], 'behance-project', '');?>
											<label class="eg-new-label eg-tooltip-wrap" title="<?php _e('Select the project you want to pull the data from', EG_TEXTDOMAIN); ?>"><?php _e('Select project', EG_TEXTDOMAIN); ?></label>
							...
							<div id="eg-external-source-behance-projects-images-wrap" class="eg-creative-settings">
								<div class="eg-cs-tbc-left">
									<h3><span><?php _e('Image Sizes', EG_TEXTDOMAIN); ?></span></h3>
								</div>
								<div class="eg-cs-tbc">
									...
									<p>
										<select name="behance-projects-thumb-size">
											<option value='115' <?php selected( $base->getVar($grid['postparams'], 'behance-projects-thumb-size', '202'), '115');?>><?php _e('115px wide', EG_TEXTDOMAIN);?></option>
											<option value='202' <?php selected( $base->getVar($grid['postparams'], 'behance-projects-thumb-size', '202'), '202');?>><?php _e('202px wide', EG_TEXTDOMAIN);?></option>
											<option value='230' <?php selected( $base->getVar($grid['postparams'], 'behance-projects-thumb-size', '202'), '230');?>><?php _e('230px wide', EG_TEXTDOMAIN);?></option>
											<option value='404' <?php selected( $base->getVar($grid['postparams'], 'behance-projects-thumb-size', '202'), '404');?>><?php _e('404px wide', EG_TEXTDOMAIN);?></option>
											<option value='original' <?php selected( $base->getVar($grid['postparams'], 'behance-projects-thumb-size', '202'), 'original');?>><?php _e('Original', EG_TEXTDOMAIN);?></option>
										</select>
									</p>
									<p>
										<label class="eg-new-label eg-tooltip-wrap" title="<?php _e('For images that appear inside the lightbox, links, etc.', EG_TEXTDOMAIN); ?>"><?php _e('Full Image Size', EG_TEXTDOMAIN); ?></label>
									...
									<p>
										<select name="behance-projects-full-size">
											<option value='115' <?php selected( $base->getVar($grid['postparams'], 'behance-projects-full-size', '202'), '115');?>><?php _e('115px wide', EG_TEXTDOMAIN);?></option>
											<option value='202' <?php selected( $base->getVar($grid['postparams'], 'behance-projects-full-size', '202'), '202');?>><?php _e('202px wide', EG_TEXTDOMAIN);?></option>
											<option value='230' <?php selected( $base->getVar($grid['postparams'], 'behance-projects-full-size', '202'), '230');?>><?php _e('230px wide', EG_TEXTDOMAIN);?></option>
											<option value='404' <?php selected( $base->getVar($grid['postparams'], 'behance-projects-full-size', '202'), '404');?>><?php _e('404px wide', EG_TEXTDOMAIN);?></option>
											<option value='original' <?php selected( $base->getVar($grid['postparams'], 'behance-projects-full-size', '202'), 'original');?>><?php _e('Original', EG_TEXTDOMAIN);?></option>
										</select>
									</p>
								</div>
							</div>
							<div id="eg-external-source-behance-project-images-wrap" class="eg-creative-settings">
								<div class="eg-cs-tbc-left">
									<h3><span><?php _e('Image Sizes', EG_TEXTDOMAIN); ?></span></h3>
								</div>
								<div class="eg-cs-tbc">
									...
									<p>
										<select name="behance-project-thumb-size">
											<option value='disp' <?php selected( $base->getVar($grid['postparams'], 'behance-project-thumb-size', 'max_1240'), 'disp');?>><?php _e('Disp', EG_TEXTDOMAIN);?></option>
											<option value='max_1200' <?php selected( $base->getVar($grid['postparams'], 'behance-project-thumb-size', 'max_1240'), 'max_1200');?>><?php _e('Max. 1200px', EG_TEXTDOMAIN);?></option>
											<option value='max_1240' <?php selected( $base->getVar($grid['postparams'], 'behance-project-thumb-size', 'max_1240'), 'max_1240');?>><?php _e('Max. 1240px', EG_TEXTDOMAIN);?></option>
											<option value='original' <?php selected( $base->getVar($grid['postparams'], 'behance-project-thumb-size', 'max_1240'), 'original');?>><?php _e('Original', EG_TEXTDOMAIN);?></option>
										</select>
									</p>
									<p>
										<label class="eg-new-label eg-tooltip-wrap" title="<?php _e('For images that appear inside the lightbox, links, etc.', EG_TEXTDOMAIN); ?>"><?php _e('Full Image Size', EG_TEXTDOMAIN); ?></label>
									...
									<p>
										<select name="behance-project-full-size">
											<option value='disp' <?php selected( $base->getVar($grid['postparams'], 'behance-project-full-size', 'max_1240'), 'disp');?>><?php _e('Disp', EG_TEXTDOMAIN);?></option>
											<option value='max_1200' <?php selected( $base->getVar($grid['postparams'], 'behance-project-full-size', 'max_1240'), 'max_1200');?>><?php _e('Max. 1200px', EG_TEXTDOMAIN);?></option>
											<option value='max1240' <?php selected( $base->getVar($grid['postparams'], 'behance-project-full-size', 'max_1240'), 'max_1240');?>><?php _e('Max. 1240px', EG_TEXTDOMAIN);?></option>
											<option value='original' <?php selected( $base->getVar($grid['postparams'], 'behance-project-full-size', 'max_1240'), 'original');?>><?php _e('Original', EG_TEXTDOMAIN);?></option>
										</select>
									</p>
								</div>
							</div>
			...
			<?php do_action('essgrid_grid_source_options',$base,$grid); ?>
							...
							<div class="eg-cs-tbc" style="padding-top:15px">								
								...
								<div style="float:left; margin-bottom: 10px;">
									<div>
										...
										/*
										if($default_img === 0) {	
											$default_global_img = get_option('tp_eg_global_default_img', '');
					...
					<div class="eg-creative-settings default-posters notavailable" id="eg-vimeo-default-poster">
						<div class="divider1"></div>
						<div class="eg-cs-tbc-left">
					...
					<div class="eg-creative-settings default-posters notavailable" id="eg-html5-default-poster">
		...
		<!--	<div style="width:150px; background:#E1e1e1;position:absolute;height:100%;top:0px;left:0px;"></div>-->
			...
			<!-- <div class="sws-toolbar-button"><a class="button-primary revpurple" id="createthumbnail" href="#"><i class="eg-icon-picture-1"></i><?php _e('Create Thumb', EG_TEXTDOMAIN); ?></a></div> -->
...
<h2><?php _e('Editor / Preview', EG_TEXTDOMAIN); ?></h2><!--div id="build_thumbnail" class="button-primary revblue">Create Thumbnail</div-->
